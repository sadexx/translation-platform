...
import { IGetPermissions } from "src/modules/permissions/common/interfaces";
...
export class PermissionsController {
  ...
  @Get()
  async getPermissions(@Query() { userRole }: GetPermissionsByRoleDto): Promise<IGetPermissions> {
