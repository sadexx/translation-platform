...
export class CompaniesEmployeeController {
  ...
  public async deleteById(@Param() { id }: UUIDParamDto, @CurrentUser() user: ITokenUserData): Promise<void> {
    return await this.companiesEmployeeService.deleteById(id, user);
  }
}
