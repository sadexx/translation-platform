...
export class CorporatePaymentInformationController {
  ...
  async createStripeCustomerForPayIn(@CurrentUser() user: ITokenUserData): Promise<ICreateStripeCustomerForPayIn> {
  ...
  async createStripeAccountForPayOut(@CurrentUser() user: ITokenUserData): Promise<IAccountLink> {
  ...
  async createStripeLoginLinkForPayOut(@CurrentUser() user: ITokenUserData): Promise<ILoginLink> {
