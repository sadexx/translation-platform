...
import { LanguagePair } from "src/modules/interpreter-profile/entities";
...
export class InterpreterProfile {
  ...
  @OneToOne(() => UserRole, (userRole) => userRole.interpreterProfile, { onDelete: "CASCADE" })
  @JoinColumn({
    name: "user_role_id",
  ...
  @Column({ type: "enum", array: true, enum: ELanguageLevel, name: "known_levels", nullable: true })
  knownLevels: ELanguageLevel[];

  @OneToMany(() => LanguagePair, (languagePair) => languagePair.interpreterProfile, { nullable: true })
