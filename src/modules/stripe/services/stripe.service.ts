...
import { ILoginLink } from "src/modules/payment-information/common/interfaces";
...
export class StripeService {
  ...
  public async createLoginLink(accountId: string): Promise<ILoginLink> {
  ...
  public async capturePayment(paymentIntentId: string): Promise<Stripe.Response<Stripe.PaymentIntent>> {
