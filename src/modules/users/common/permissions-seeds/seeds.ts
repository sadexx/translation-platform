...
export const users: IMethodSeed = {
  ...
  "DELETE /v1/users/me/delete-by-id-request": {
    description: "01.02. Create request for user deleting",
    roles: allRolesAllowedAndNotEditable,
    isNotEditableForOtherRoles: false,
  },
  "POST /v1/users/me/restore-user": {
    description: "01.03. Restore user",
    roles: allRolesAllowedAndNotEditable,
    isNotEditableForOtherRoles: false,
  },
  "POST /v1/users/me/change-registered-phone": {
    description: "01.04. Change registered phone",
    roles: allRolesAllowedAndNotEditable,
    isNotEditableForOtherRoles: false,
  },
  "PATCH /v1/users/me/verify-new-phone": {
    description: "01.05. Verify new phone",
    roles: allRolesAllowedAndNotEditable,
    isNotEditableForOtherRoles: false,
  },
  "POST /v1/users/me/change-registered-email": {
    description: "01.06. Change registered email",
    roles: allRolesAllowedAndNotEditable,
    isNotEditableForOtherRoles: false,
  },
  "PATCH /v1/users/me/verify-new-email": {
    description: "01.07. Verify new email",
    roles: allRolesAllowedAndNotEditable,
    isNotEditableForOtherRoles: false,
  },
  "PATCH /v1/users/me/change-registered-password": {
    description: "01.08. Change registered password",
    roles: allRolesAllowedAndNotEditable,
    isNotEditableForOtherRoles: false,
  },
  "POST /v1/users/:id/profile-information": {
    description: "03.01. Create profile",
    roles: allRolesAllowedAndNotEditable,
    isNotEditableForOtherRoles: false,
  },
  "GET /v1/users/:id/profile-information": {
    description: "03.02. Get profile information",
    roles: allRolesAllowedAndNotEditable,
    isNotEditableForOtherRoles: false,
  },
  "PATCH /v1/users/:id/profile-information": {
