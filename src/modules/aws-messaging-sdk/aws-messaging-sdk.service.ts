...
export class AwsMessagingSdkService {
  ...
  private readonly messagingRegion: string;
  ...
  constructor(private configService: ConfigService) {
    ...
    this.messagingRegion = chimeMessagingControlRegion;

    if (ENVIRONMENT === EEnvironment.PRODUCTION) {
      this.identityClient = new ChimeSDKIdentityClient({ region: this.messagingRegion });
      this.messagingClient = new ChimeSDKMessagingClient({ region: this.messagingRegion });
    } else {
      this.identityClient = new ChimeSDKIdentityClient({
        region: this.messagingRegion,
