...
export class AccountActivationController {
  ...
  async finishAccountActivation(@CurrentUser() user: ICurrentUserData): Promise<FinishAccountActivationStepsOutput> {
    return await this.accountActivationService.activateAccount(user);
  }
