...
export class LanguageDocCheckController {
  ...
  async languageDocCheckManualDecision(@Body() dto: LanguageDocCheckManualDecisionDto): Promise<void> {
    return this.languageDocCheckService.languageDocCheckManualDecision(dto);
  }

  @UseGuards(JwtFullAccessGuard, RolesGuard)
  @HttpCode(HttpStatus.NO_CONTENT)
  @Delete()
  async removeLanguageDocCheck(@Query() { id }: UUIDParamDto): Promise<void> {
    return this.languageDocCheckService.removeLanguageDocCheck(id);
  }
