...
import { CreateExtraDayFaceToFaceDto, CreateExtraDayVirtualDto } from "src/modules/appointments/common/dto";
...
export class BookingSlotManagementService {
  ...
  private buildTimeRangesForCreated(extraDays: Appointment[]): Array<{ start: Date; end: Date }> {
