...
import { IContactFormsCsv } from "./csv-data/contact-forms-csv.interface";
...
export interface IContactFormsTestCsvData {
  fileName: ECsvName.TEST;
  csvDataMapping: Record<keyof IContactFormsCsv, string>;
  fetchDataFn: (offset: number, limit: number) => Promise<IContactFormsCsv[]>;
}
