...
import { contactFormCsvDataMapping } from "../common/interfaces/csv-data/contact-forms-csv.interface";
...
export class CsvService {
  ...
  public async exportContactFormsTestCsv(res: Response): Promise<void> {
    const options: ICsvData = {
      data: {
        fileName: ECsvName.TEST,
        csvDataMapping: contactFormCsvDataMapping,
        fetchDataFn: this.csvBuilderService.getContactFormTestData.bind(this.csvBuilderService),
      },
    };
    await this.exportCsv(res, options);
  }
}
