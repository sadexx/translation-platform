export enum EUserRoleName {
  ...
  CORPORATE_INTERPRETING_PROVIDER_CORPORATE_CLIENTS_SUPER_ADMIN = "corporate-interpreting-provider-corporate-clients-super-admin",
  CORPORATE_INTERPRETING_PROVIDER_CORPORATE_CLIENTS_ADMIN = "corporate-interpreting-provider-corporate-clients-admin",
  CORPORATE_INTERPRETING_PROVIDER_CORPORATE_CLIENTS_RECEPTIONIST = "corporate-interpreting-provider-corporate-clients-receptionist",
  CORPORATE_INTERPRETING_PROVIDER_CORPORATE_CLIENTS_IND_USER = "corporate-interpreting-provider-corporate-clients-ind-user",
}
